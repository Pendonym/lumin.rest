          ...
          <BlurFade delay={0.15} inView>
            <div className="text-center mb-2">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Choose how you want to access lumin.rocks
              </p>
            </div>
          </BlurFade>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <BlurFade delay={0.25} inView>
              <Card className="w-[300px] flex flex-col">
                <CardHeader>
                  ...
                  <CardDescription>
                    Temporary access via key system
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex-1">
                  <ul className="space-y-2">
                    <Perk>7 hour access to lumin.rocks</Perk>
            ...
            <BlurFade delay={0.35} inView>
              <Card className="w-[300px] flex flex-col border-[#f8bfd4]/30">
                ...
                <CardContent className="flex-1">
                  <ul className="space-y-2">
                    <Perk>Permanent access to lumin.rocks</Perk>
                    <Perk>All supported games</Perk>
                ...
                <CardFooter className="flex-col gap-2">
                  ...
                  <Link href="/key/robux" className="w-full">
                    <Button variant="outline" className="w-full cursor-pointer">
                      Buy with Robux
                    </Button>
                  </Link>
